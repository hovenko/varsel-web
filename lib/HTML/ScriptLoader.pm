...
HTML::ScriptLoader - Class for loading scripts on a web page
...
This class handles script loading with dependency support.

The available scripts can be setup in the configuration file and added on
runtime. When a script is needed, you call on L</add_script>, and that one
